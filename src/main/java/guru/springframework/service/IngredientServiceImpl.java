...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand findByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
       ...
       {
           log.error("ingredient Id cannot be found,ingredient Id: " + ingredientId);
       }
    ...
    public void deleteById(Long recipeId, Long ingredientId) {
        ...
        if(!recipeOptional.isPresent())
        {
            log.error("cannot delete ingredient, because Recipe id not found : " + recipeId);
            ...
            if (ingredientOptional.isPresent()) {
                ...
                log.error("cannot delete ingredient, because ingredient id not found : " + ingredientId);
